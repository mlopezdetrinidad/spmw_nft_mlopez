...
contract ERC721 {
    ...
    event Approval(address indexed _owner, address _approved, uint256 _tokenId);

    event ApprovalForAll(address _owner, address indexed _operator, bool _approved);
    ...
    //  Checks if an address is an operator for antoher address
